...
public class TestHibernate {
	...
	public static void main(String[] args) {
		...
		employee.setPermanentAddress(permanentAddressVO);
		
		AddressVO temporaryAddressVO = new AddressVO();
		
		temporaryAddressVO.setAddressLine("Hogwarts School of Witchcraft and Wizardry");
		temporaryAddressVO.setState("Scotland");
		temporaryAddressVO.setCountry("United Kingdom");
		
		employee.setCurrentAddress(temporaryAddressVO);
